...
export default function SidebarNav({ userEmail }: { userEmail: string }) {
  ...
  return (
    <>
      ...
      <aside
        className={`w-64 shrink-0 h-screen fixed md:sticky top-0 left-0 z-50 flex flex-col border-r border-paperLine bg-white transition-transform duration-200 md:translate-x-0 ${
