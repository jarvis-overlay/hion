...
const TEMPLATES: { id: string; label: string; desc: string; thumb: string; layoutStyle: LayoutStyle; theme: Theme }[] = [
  ...
  },
  {
    id: 'overlay-bright',
    label: '오버레이 브라이트',
    desc: '사진 위 밝고 화사한 그라데이션+문구',
    thumb: '/templates/overlay-bright.jpg',
    layoutStyle: 'overlay',
    theme: 'light',
  },
  {
    id: 'overlay-mood',
    label: '오버레이 퍼플 무드',
    desc: '사진 위 퍼플 그라데이션 - 감성/무드 라이프스타일',
    thumb: '/templates/overlay-mood.jpg',
    layoutStyle: 'overlay',
    theme: 'purple',
  },
  {
  ...
  },
  {
    id: 'brand-mood-light',
    label: '브랜드 무드 (라이트)',
    desc: '파스텔 배경+브랜드명 (스킨케어/뷰티형)',
    thumb: '/templates/brand-mood-light.jpg',
    layoutStyle: 'typography',
    theme: 'light',
  },
  {
    id: 'quote-minimal',
    label: '미니멀 카피',
    desc: '여백 강조, 인용구+헤드라인만 (담백한 브랜드 톤)',
    thumb: '/templates/quote-minimal.jpg',
    layoutStyle: 'typography',
    theme: 'light',
  },
  {
